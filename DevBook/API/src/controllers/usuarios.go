...
//PararDeSeguirUsuario permite que um usário deixe de seguir o outro
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		respostas.Erro(w, http.StatusBadRequest, errors.New("a senha atual não condiz com a que está salva no banco"))
		return
	}
